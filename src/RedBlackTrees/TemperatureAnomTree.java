...
// Portions of this code were taken from Algorithms 4th ed. by Sedgewick and Wayne
 ...
 */
public class TemperatureAnomTree<Key extends Comparable<Key>, Value> {
    ...
    /**
     * Returns the color of the given k
     * @param k the key
     * @return the color of the key in the tree. (<em>Red/Black</em>)
     */
    public String getColor(Key k) {
        return getColor(root, k);
    }

    // Helper method for public getColor
    private String getColor(Node x, Key k){
        while(x!= null) {
